var urlTools = require('urltools'),
    _ = require('lodash'),
    loadAndInstantiateAutoprefixer = require('../loadAndInstantiateAutoprefixer');
...
module.exports = function (options) {
    ...
    if (options.browsers) {
        autoprefixer = loadAndInstantiateAutoprefixer(options.browsers, 'The \'browsers\' option requires the autoprefixer module to be available. Please install it in the containing project.');
    ...
    return function buildProduction(assetGraph, cb) {
        ...
        assetGraph
            ...
            .splitCssIfIeLimitIsReached({type: 'Css'}, {minimumIeVersion: browsers.minimum('ie'), rulesPerStylesheetLimit: 50000})
